...
<table align="center">
  <tr>
    <td width="50%">
      ...
      API contract testing that detects discrepancies between a spec and the live implementation and logs them for triage.<br>
    ...
    <td width="50%">
      ...
      Kubernetes admission controller PoC for policy-gated, attestation-checked workloads.<br>
  ...
  <tr>
    <td width="50%">
      ...
      Spring Boot with an embedded Infinispan distributed cache cluster.<br>
    ...
    <td width="50%">
      ...
      MariaDB Galera multi-master cluster on Kubernetes, fronted by MaxScale routing.<br>
  ...
  <tr>
    ...
    <td width="50%">
      ...
      Runtime proxy creation via JDK dynamic proxies and cglib.<br>
